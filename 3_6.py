...
#int_func(words=str(input('Enter the words: ').split(' '))) это для себя информация

print(int_func(words=str(input('Enter the words: ').split(' '))))

#не придумал, как список в строчку перевести, через .join никак.
